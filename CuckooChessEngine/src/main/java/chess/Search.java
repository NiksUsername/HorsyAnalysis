...
public class Search {
    ...
    public interface Listener {
        ...
        void notifyPV(int depth, int score, int time, long nodes, int nps, boolean lowerBound, ArrayList<Move> pv);
...
/*                        System.out.printf("%2d %5d %5d %5d %6d %6d ",
    ...
    public void notifyPV(int depth, int score, boolean uBound, boolean lBound, Move m) {
        if (listener != null) {
            ...
            listener.notifyPV(depth, score, time, totalNodes, nps, isMate, pv);
        }
    }
